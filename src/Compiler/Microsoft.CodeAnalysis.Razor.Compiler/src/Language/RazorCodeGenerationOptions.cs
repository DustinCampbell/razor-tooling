    ...
    bool remapLinePragmaPathsOnWindows)
{
    ...
    /// </summary>
    public bool SupportLocalizedComponentNames { get; } = supportLocalizedComponentNames;
    ...
    /// </summary>
    internal string? SuppressUniqueIds { get; } = suppressUniqueIds;

    /// <summary>
    /// Determines whether RenderTreeBuilder.AddComponentParameter should not be used.
    /// </summary>
    internal bool SuppressAddComponentParameter { get; } = suppressAddComponentParameter;
