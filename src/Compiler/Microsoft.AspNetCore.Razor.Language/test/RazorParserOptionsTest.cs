...
public class RazorParserOptionsTest
{
    ...
    {
        // Arrange & Act
        var options = RazorParserOptions.Create(RazorLanguageVersion.Latest, FileKinds.Legacy);
    ...
    {
        // Arrange & Act
        var options = RazorParserOptions.Create(RazorLanguageVersion.Version_2_1, FileKinds.Legacy);
    ...
    {
        // Arrange & Act
        var options = RazorParserOptions.Create(RazorLanguageVersion.Version_1_0, FileKinds.Legacy);
