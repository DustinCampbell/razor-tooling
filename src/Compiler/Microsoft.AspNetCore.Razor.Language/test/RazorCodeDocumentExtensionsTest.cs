...
public class RazorCodeDocumentExtensionsTest
{
    ...
    public void TryComputeNamespace_ComputesNamespace()
    {
        ...
        var codeDocument = new RazorCodeDocument(sourceDocument, imports: default, parserOptions: null,
            codeGenerationOptions: RazorCodeGenerationOptions.Create(c =>
            {
    ...
    public void TryComputeNamespace_RespectsNamespaceDirective()
    {
        ...
        {
            options.Directives.Add(NamespaceDirective.Descriptor);
        })));
