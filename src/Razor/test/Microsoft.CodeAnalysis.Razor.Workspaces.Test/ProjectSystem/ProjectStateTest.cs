...
public class ProjectStateTest : WorkspaceTestBase
{
    ...
    public void GetImportDocumentTargetPaths_DoesNotIncludeCurrentImport()
    {
        ...
        // Act
        var paths = state.ProjectEngine.GetImportDocumentTargetPaths(TestProjectData.SomeProjectComponentImportFile1);
    ...
    public void ProjectState_ConstructedNew()
    {
        ...
        // Assert
        Assert.Empty(state.DocumentStates);
    ...
    public void ProjectState_AddHostDocument_ToEmpty()
    {
        ...
        Assert.Collection(
            state.DocumentStates.OrderBy(kvp => kvp.Key),
    ...
    public async Task ProjectState_AddHostDocument_DocumentIsEmpty()
    {
        ...
        // Assert
        var text = await state.DocumentStates[_documents[0].FilePath].GetTextAsync(DisposalToken);
    ...
    public void ProjectState_AddHostDocument_RetainsComputedState()
    {
        ...
        Assert.Same(original.DocumentStates[_documents[1].FilePath], state.DocumentStates[_documents[1].FilePath]);
        Assert.Same(original.DocumentStates[_documents[2].FilePath], state.DocumentStates[_documents[2].FilePath]);
    }
    ...
    public async Task ProjectState_WithChangedHostDocument_Loader()
    {
        ...
        // Act
        var state = original.UpdateDocumentText(_documents[1].FilePath, _textLoader);

        // Assert
        Assert.NotEqual(original.Version, state.Version);

        var text = await state.DocumentStates[_documents[1].FilePath].GetTextAsync(DisposalToken);
    ...
    public async Task ProjectState_WithChangedHostDocument_Snapshot()
    {
        ...
        // Act
        var state = original.UpdateDocumentText(_documents[1].FilePath, _text);
    ...
    public void ProjectState_WithChangedHostDocument_Loader_RetainsComputedState()
    {
        ...
        Assert.NotSame(original.DocumentStates[_documents[1].FilePath], state.DocumentStates[_documents[1].FilePath]);
    }
    ...
    public void ProjectState_WithChangedHostDocument_Loader_NotFoundNoops()
    {
        ...
        // Act
        var state = original.UpdateDocumentText(_documents[0].FilePath, _textLoader);
    ...
    public void ProjectState_WithChangedHostDocument_Snapshot_NotFoundNoops()
    {
        ...
        // Act
        var state = original.UpdateDocumentText(_documents[0].FilePath, _text);
    ...
    public void ProjectState_WithHostProject_ConfigurationChange_UpdatesConfigurationState()
    {
        ...
        Assert.NotSame(original.DocumentStates[_documents[1].FilePath], state.DocumentStates[_documents[1].FilePath]);
        Assert.NotSame(original.DocumentStates[_documents[2].FilePath], state.DocumentStates[_documents[2].FilePath]);
    ...
    public void ProjectState_WithHostProject_CallsConfigurationChangeOnDocumentState()
    {
        ...
        var original = ProjectState.Create(ProjectEngineFactoryProvider, LanguageServerFeatureOptions, _hostProject, _projectWorkspaceState);
        original.DocumentStates = documents.ToImmutable();
    ...
    public void ProjectState_WhenImportDocumentChangedTextLoader_CallsImportsChanged()
    {
        ...
        // Act
        var state = original.UpdateDocumentText(document5.FilePath, DocumentState.EmptyLoader);
    ...
    public void ProjectState_WhenImportDocumentChangedSnapshot_CallsImportsChanged()
    {
        ...
        // Act
        var state = original.UpdateDocumentText(document5.FilePath, _text);
