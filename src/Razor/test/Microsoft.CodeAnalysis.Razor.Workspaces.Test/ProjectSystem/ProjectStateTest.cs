...
public class ProjectStateTest(ITestOutputHelper testOutput) : ToolingTestBase(testOutput)
{
    ...
    public async Task ProjectState_WithDocumentText_Loader()
    {
        ...
        // Act
        var newState = state.WithDocumentText(s_documents[1], s_textLoader);
    ...
    public async Task ProjectState_WithDocumentText_Snapshot()
    {
        ...
        // Act
        var newState = state.WithDocumentText(s_documents[1], s_text, VersionStamp.Create());
    ...
    public void ProjectState_WithDocumentText_Loader_NotFoundIgnored()
    {
        ...
        // Act
        var newState = state.WithDocumentText(s_documents[0], s_textLoader);
    ...
    public void ProjectState_WithDocumentText_Snapshot_NotFoundIgnored()
    {
        ...
        // Act
        var newState = state.WithDocumentText(s_documents[0], s_text, VersionStamp.Create());
    ...
    public void ProjectState_WithImportDocumentText_UpdatesRelatedDocuments_TextLoader()
    {
        ...
        // Act
        var newState = state.WithDocumentText(TestProjectData.AnotherProjectNestedImportFile, EmptyTextLoader.Instance);
    ...
    public void ProjectState_WithImportDocumentText_UpdatesRelatedDocuments_Snapshot()
    {
        ...
        // Act
        var newState = state.WithDocumentText(TestProjectData.AnotherProjectNestedImportFile, s_text, VersionStamp.Create());
