...
public class ProjectSnapshotManagerTest : VisualStudioWorkspaceTestBase
{
    ...
    public async Task DocumentAdded_CachesTagHelpers()
    {
        ...
        var originalTagHelpers = await _projectManager.GetRequiredProject(s_hostProject.Key).GetTagHelpersAsync(DisposalToken);
        ...
        // Assert
        var newTagHelpers = await _projectManager.GetRequiredProject(s_hostProject.Key).GetTagHelpersAsync(DisposalToken);
    ...
    public async Task UpdateProjectConfiguration_DoesNotCacheProjectEngine()
    {
        ...
        var updatedProject = _projectManager.GetRequiredProject(s_hostProject.Key);
    ...
    public async Task ProjectWorkspaceStateChanged_UpdateDocuments()
    {
        ...
        // Assert
        var document = _projectManager.GetRequiredProject(s_hostProject.Key).GetRequiredDocument(s_documents[0].FilePath);
