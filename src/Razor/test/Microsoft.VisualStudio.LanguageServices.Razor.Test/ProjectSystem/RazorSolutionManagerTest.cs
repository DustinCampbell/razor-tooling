...
public class RazorSolutionManagerTest : VisualStudioWorkspaceTestBase
{
    ...
    public async Task Initialize_DoneInCorrectOrderBasedOnInitializePriorityPriority()
    {
        ...
        solutionManager.Changed += delegate { initializedOrder.Add("lowPriority"); };
        solutionManager.PriorityChanged += delegate { initializedOrder.Add("highPriority"); };
    ...
    public async Task AddDocument_AddsDocument()
    {
        ...
        // Assert
        var project = _solutionManager.GetRequiredProject(s_hostProject.Key);
    ...
    public async Task AddDocument_IgnoresUnknownProject()
    {
        ...
        // Assert
        var projectKeys = _solutionManager.GetProjectKeysWithFilePath(s_hostProject.FilePath);
    ...
    public async Task AddDocument_CachesTagHelpers()
    {
        ...
        var originalTagHelpers = await _solutionManager
        ...
        // Assert
        var newTagHelpers = await _solutionManager
            .GetRequiredProject(s_hostProject.Key)
            .GetTagHelpersAsync(DisposalToken);
    ...
    public async Task AddDocument_CachesProjectEngine()
    {
        ...
        // Assert
        var newProjectEngine = _solutionManager.GetRequiredProject(s_hostProject.Key).ProjectEngine;
    ...
    public async Task OpenDocument_UpdatesDocument()
    {
        ...
        var document = _solutionManager.GetRequiredDocument(s_hostProject.Key, s_documents[0].FilePath);

        var text = await document.GetTextAsync(DisposalToken);
        Assert.Same(_sourceText, text);

        Assert.True(_solutionManager.IsDocumentOpen(s_documents[0].FilePath));
    ...
    public async Task CloseDocument_UpdatesDocument()
    {
        ...
        Assert.False(_solutionManager.IsDocumentOpen(s_documents[0].FilePath));
    ...
    public async Task UpdateProjectWorkspaceState_ConfigurationChange_DoesNotCacheProjectEngine()
    {
        ...
        // Assert
        var newProjectEngine = _solutionManager.GetRequiredProject(s_hostProjectWithConfigurationChange.Key).ProjectEngine;
    ...
    public async Task NestedNotifications_NotifiesListenersInCorrectOrder()
    {
        ...
        _solutionManager.Changed += (sender, args) =>
        {
            ...
            {
                _solutionManager.UpdateAsync(updater =>
