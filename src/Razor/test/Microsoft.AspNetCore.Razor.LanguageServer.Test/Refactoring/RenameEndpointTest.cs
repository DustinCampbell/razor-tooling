...
public class RenameEndpointTest(ITestOutputHelper testOutput) : LanguageServerTestBase(testOutput)
{
        ...
        IClientConnection? clientConnection = null)
    {
        ...
        {
            updater.ProjectWorkspaceStateChanged(projectKey1, new ProjectWorkspaceState(tagHelpers));
        });
        ...
        await projectManager.UpdateAsync(updater =>
        {
            updater.ProjectWorkspaceStateChanged(projectKey2, new ProjectWorkspaceState(tagHelpers));
        });
