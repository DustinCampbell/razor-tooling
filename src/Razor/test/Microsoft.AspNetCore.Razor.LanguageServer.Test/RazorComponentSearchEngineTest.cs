...
#nullable enable
    ...
    public async Task Handle_SearchFound_GenericComponent()
    {
        ...
        // Act
        var documentSnapshot1 = await searchEngine.TryLocateComponentAsync(tagHelperDescriptor1, _projectManager.GetSolutionSnapshot());
        var documentSnapshot2 = await searchEngine.TryLocateComponentAsync(tagHelperDescriptor2, _projectManager.GetSolutionSnapshot());
    ...
    public async Task Handle_SearchFound_SetNamespace()
    {
        ...
        // Act
        var documentSnapshot = await searchEngine.TryLocateComponentAsync(tagHelperDescriptor, _projectManager.GetSolutionSnapshot());
