...
<p>@{
    ...
    private static RazorCodeDocument CreateCodeDocument(string text, string? fileKind = null)
    {
        ...
        var codeDocument = projectEngine.ProcessDesignTime(sourceDocument, fileKind ?? FileKinds.Legacy, importSourceDocuments: default, Array.Empty<TagHelperDescriptor>());
        return codeDocument;
    }
}
