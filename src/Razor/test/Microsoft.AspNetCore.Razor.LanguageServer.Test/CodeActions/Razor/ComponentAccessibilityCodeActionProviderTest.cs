...
public class ComponentAccessibilityCodeActionProviderTest(ITestOutputHelper testOutput) : LanguageServerTestBase(testOutput)
{
    ...
    {
        var shortComponent = TagHelperDescriptorBuilder.Create(ComponentMetadata.Component.Kind, "Fully.Qualified.Component", "TestAssembly");
        ...
        var fullyQualifiedComponent = TagHelperDescriptorBuilder.Create(ComponentMetadata.Component.Kind, "Fully.Qualified.Component", "TestAssembly");
        ...
        var shortGenericComponent = TagHelperDescriptorBuilder.Create(ComponentMetadata.Component.Kind, "Fully.Qualified.GenericComponent<T>", "TestAssembly");
        ...
        var fullyQualifiedGenericComponent = TagHelperDescriptorBuilder.Create(ComponentMetadata.Component.Kind, "Fully.Qualified.GenericComponent<T>", "TestAssembly");
