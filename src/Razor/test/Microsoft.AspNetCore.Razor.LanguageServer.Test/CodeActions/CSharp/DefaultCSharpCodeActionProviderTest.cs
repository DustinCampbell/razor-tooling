...
$$Path;
        ...
        bool supportsCodeActionResolve = true)
    {
        ...
        var context = new RazorCodeActionContext(request, documentSnapshot, codeDocument, location, sourceDocument.Text, supportsFileCreation, supportsCodeActionResolve);
