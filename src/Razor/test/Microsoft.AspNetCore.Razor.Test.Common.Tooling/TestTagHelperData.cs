...
internal static class TestTagHelperData
{
    public static ImmutableArray<TagHelperDescriptor> DefaultTagHelpers { get; } = CreateDefaultTagHelpers();

    private static ImmutableArray<TagHelperDescriptor> CreateDefaultTagHelpers()
    {
