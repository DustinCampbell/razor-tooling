...
{
    private static readonly RazorParserOptions s_defaultOptions = RazorParserOptions.Default.WithFlags(enableSpanEditHandler: true);
    ...
    public void AtApplicableRazorBlock_AtMetacode_ReturnsTrue()
    {
        ...
        var parseOptions = RazorParserOptions.Default
            ...
            .WithFlags(enableSpanEditHandler: true);
