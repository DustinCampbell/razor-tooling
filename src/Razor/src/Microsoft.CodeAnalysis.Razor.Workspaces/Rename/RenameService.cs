    ...
    LanguageServerFeatureOptions languageServerFeatureOptions) : IRenameService
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var solution = documentContext.Snapshot.Project.Solution;

        var originComponentDocumentSnapshot = await _componentSearchEngine
            .TryLocateComponentAsync(originTagHelpers.First(), solution, cancellationToken)
        ...
        var documentSnapshots = GetAllDocumentSnapshots(documentContext.FilePath, solution);
    ...
    private static ImmutableArray<IDocumentSnapshot> GetAllDocumentSnapshots(string filePath, ISolutionSnapshot solution)
    {
