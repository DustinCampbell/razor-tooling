...
internal class RazorComponentSearchEngine(ILoggerFactory loggerFactory) : IRazorComponentSearchEngine
{
    ...
    /// <param name="solutionSnapshot">An <see cref="ISolutionSnapshot"/> to enumerate project snapshots.</param>
    ...
    public async Task<IDocumentSnapshot?> TryLocateComponentAsync(TagHelperDescriptor tagHelper, ISolutionSnapshot solutionSnapshot)
    {
