...
internal class ProjectState
{
    ...
    public ProjectState WithAddedHostDocument(HostDocument hostDocument, RazorTextLoader loader)
    {
    ...
    public ProjectState WithChangedHostDocument(HostDocument hostDocument, RazorTextLoader loader)
    {
        if (hostDocument is null)
        {
            throw new ArgumentNullException(nameof(hostDocument));
