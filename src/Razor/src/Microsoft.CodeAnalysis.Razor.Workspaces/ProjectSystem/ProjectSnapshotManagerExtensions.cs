...
internal static class ProjectSnapshotManagerExtensions
{
    ...
    public static bool TryGetDocument(this ProjectSnapshotManager.Updater updater, ProjectKey projectKey, string filePath, [NotNullWhen(true)] out IDocumentSnapshot? document)
    {
    ...
    public static IDocumentSnapshot? GetDocument(this ProjectSnapshotManager.Updater updater, ProjectKey projectKey, string filePath)
        => updater.TryGetDocument(projectKey, filePath, out var result)
            ? result
            : null;

    public static IDocumentSnapshot GetRequiredDocument(this ProjectSnapshotManager.Updater updater, ProjectKey projectKey, string filePath)
