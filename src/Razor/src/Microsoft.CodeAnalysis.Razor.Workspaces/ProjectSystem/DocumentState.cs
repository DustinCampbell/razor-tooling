...
internal partial class DocumentState
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        return forceRuntimeCodeGeneration
            ? projectEngine.Process(source, document.FileKind.ToRazorFileKind(), importSources, tagHelpers)
            : projectEngine.ProcessDesignTime(source, document.FileKind.ToRazorFileKind(), importSources, tagHelpers);
    }
