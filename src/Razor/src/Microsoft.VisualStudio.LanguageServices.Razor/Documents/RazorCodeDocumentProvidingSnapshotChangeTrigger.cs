...
{
    private readonly HashSet<string> _openDocuments = new(FilePath.Comparer);
    private readonly Dictionary<string, ProjectKey> _documentProjectMap = new(FilePath.Comparer);
