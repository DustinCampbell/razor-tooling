...
#pragma warning disable RS0030 // Do not use banned APIs
    ...
    public void EnqueueUpdate(Project? workspaceProject, RazorProject project)
    {
        ...
        lock (_updates)
        {
            ...
            _updates[projectKey] = UpdateItem.CreateAndStartWork(
                token => UpdateWorkspaceStateAsync(workspaceProject, project, token));
        }
    }
    ...
    private async Task UpdateWorkspaceStateAsync(Project? workspaceProject, RazorProject project, CancellationToken cancellationToken)
    {
        var projectKey = project.Key;
        ...
        try
        {
            ...
            var workspaceState = await GetProjectWorkspaceStateAsync(workspaceProject, project, cancellationToken);
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var tagHelpers = await _tagHelperResolver
                .GetTagHelpersAsync(workspaceProject, project, cancellationToken)
                .ConfigureAwait(false);
            watch.Stop();
