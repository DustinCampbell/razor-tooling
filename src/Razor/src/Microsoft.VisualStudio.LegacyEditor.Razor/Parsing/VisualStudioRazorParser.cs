...
#pragma warning restore VSTHRD003 // Avoid awaiting foreign Tasks
    ...
    internal void StartParser()
    {
        ...
        _projectEngine = _projectEngineFactoryProvider.Create(projectSnapshot, ConfigureProjectEngine);
        ...
        var fileKind = projectSnapshot.GetDocument(_documentTracker.FilePath)?.FileKind.ToRazorFileKind() ?? RazorFileKinds.GetFileKindFromFilePath(_documentTracker.FilePath);
